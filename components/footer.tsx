...
export function Footer() {
  return (
    <footer className="glass-morphism border-t border-border/50 mt-32">
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 md:items-start">
          {/* Brand */}
          <div className="flex-1 min-w-0 md:max-w-sm space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              manipulation with 99.9% accuracy.
            </p>
          ...
          {/* Product, Company, Resources - 2 columns side by side */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-8 gap-y-6 sm:gap-x-12">
        ...
        <div className="mt-8 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm text-center sm:text-left">
            © 2024 FASSD. All rights reserved.
          </p>
